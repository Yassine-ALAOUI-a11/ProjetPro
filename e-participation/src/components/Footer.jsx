      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
          ...
          <div className="md:col-span-1">
            <Link to="/" className="inline-block mb-6 bg-white/5 p-3 rounded-xl border border-white/10">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><Link to="/petitions" className="text-sm text-gray-400 hover:text-white transition-colors flex items-center gap-2"><span className="w-1 h-1 rounded-full bg-brand-blue"></span> {t('footer.petitions')}</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><Link to={user ? "/client/soumettre" : "/login"} className="text-sm text-gray-400 hover:text-white transition-colors flex items-center gap-2"><span className="w-1 h-1 rounded-full bg-brand-purple"></span> {t('footer.submit_idea')}</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a href="mailto:yassinealaoui095@gmail.com" className="text-sm text-gray-400 hover:text-white transition-colors flex items-center gap-2">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  yassinealaoui095@gmail.com
                </a>
              </li>
