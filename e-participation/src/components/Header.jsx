...
import { Bell, Globe, LogIn, LogOut, ChevronDown, Check } from 'lucide-react';
...
const Header = () => {
  ...
  const getNavClass = (path) => {
    ...
    return isActive
      ? "text-brand-blue bg-brand-lightblue/30 px-3 py-2 rounded-md font-medium text-sm transition-colors"
      : "text-gray-600 hover:text-brand-blue px-3 py-2 rounded-md font-medium text-sm transition-colors";
  };
        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex-shrink-0 flex items-center gap-4">
            <Link to="/" className="flex items-center gap-4">
              <div className="text-2xl font-bold flex items-center tracking-tight" dir="ltr">
          ...
          <nav className="hidden md:flex space-x-8 rtl:space-x-reverse">
            ...
            <Link to="/petitions" className={getNavClass("/petitions")}>
              {t('header.petitions')}
            </Link>
          ...
          <div className="flex items-center space-x-6 rtl:space-x-reverse">
            ...
            {user ? (
              <div className="flex items-center gap-4">
                ...
                >
                  <span className="text-[11px] font-bold text-gray-400 uppercase tracking-widest">Mon Espace</span>
                  <span className="text-sm font-bold text-brand-navy">{user.email}</span>
                </Link>
