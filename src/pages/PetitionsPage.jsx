      ...
      <div className="max-w-7xl mx-auto">
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-3xl p-12 text-center border border-gray-100 shadow-sm max-w-xl mx-auto">
            ...
            <h3 className="text-lg font-black text-brand-navy mb-2">Aucune e-Pétition active</h3>
            <p className="text-gray-500 text-sm font-medium">Il n'y a aucune initiative citoyenne en cours pour le moment.</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {petitions.map((p) => {
