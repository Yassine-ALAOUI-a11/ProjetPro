  ...
  useEffect(() => {
    ...
    const fetchStats = async () => {
      try {
        ...
        if (userCount !== null) {
          setCitizensCount(userCount);
        }

        setStats({
          total: totalCount !== null ? totalCount : 0,
          processed: processedCount !== null ? processedCount : 0,
          rate: totalCount > 0 ? rate : 0,
          pending: pendingCount !== null ? pendingCount : 0
        });
      } catch (err) {
          ...
          <div className="max-w-3xl">
            ...
            <div className="mt-12 flex items-center gap-4">
              ...
              <div className="text-sm">
                <span className="font-bold block">{t('home.citizens_count', { count: citizensCount })}</span>
